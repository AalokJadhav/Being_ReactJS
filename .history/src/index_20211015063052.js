...
ReactDom.render(
  ...
  <>
    ...
    <h4>🔵 <u>Challenge</u> - As Timeline change the expression of farewell (ie.Good Morning/Afternoon/Night)</h4>
    <div className="challenge1">
      <h1>Hello Sir...<span style={cssStyle}> {greeting}</span></h1>
    </div>
    <br />

    <h4>🔵 <u>Functionals Components</u> - </h4><br />
    <div className="content">
      <h5 style={{fontFamily: 'serif'}}>Netflix Top Series</h5>
      <ol>
