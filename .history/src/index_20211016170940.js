...
return(
  <>
      <div className="cards">
        <div className="card">
          <img src="https://wallpapercave.com/wp/jbxNobT.jpg" alt="friends" className="card__img"/>
            <div className="card__info">
              <span className="card__category">A Netflix Series</span>
              <h3 className="card__title">F.R.I.E.N.D.S</h3>
              <a href="https://www.netflix.com/in/title/70153404" target="_blank">
