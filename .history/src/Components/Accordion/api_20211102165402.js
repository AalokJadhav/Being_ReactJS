export const questions = [

    {
        ...
        answer: 'React is an open-source frontend JavaScript library which is used for building user interfaces especially for single page applications. It is used for handling view layer for web and mobile apps. React was created by Jordan Walke, a software engineer working for Facebook. React was first deployed on Facebook News Feed in 2011 and on Instagram in 2012.',
    },
    {
        id: 2,
    ...
    {
        id: 3,
        question: 'When to use a Class Component over Function Component?',
